...
export default function Car_Details4(){
    return(
        <div>
            <div>
                <div className="flex justify-center py-12 font-bold text-3xl underline "><h1 className="w-[60%] text-center">Honda Civic 2024 Price in Pakistan,Images,Reviews and Specs</h1></div>
                <div className="flex justify-center py-6 "><img src="car_4.jpg" alt="Honda Civic"className="border-2" /></div>
